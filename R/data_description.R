...
#'
#' Abundances and presence absence of 11 species simulated using package \href{https://github.com/Farewe/virtualspecies}{virtualspecies} .
...
#' Values for simulated species around rural property locations in Amapá, Brazil.
#'
#' Abundances and presence absence of 3 carnivore species simulated using package \href{https://github.com/Farewe/virtualspecies}{virtualspecies} .
