...
Abundances and presence absence of 11 species simulated using package
[virtualspecies](https://github.com/Farewe/virtualspecies) . The species
have contrasting responses to forest cover. The response patterns follow
those known for primate and carnivore species (Michalski & Peres 2005;
...
#> 
#> sppA sppB sppC sppD sppE sppF sppG sppH sppI sppJ sppK 
